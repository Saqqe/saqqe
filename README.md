...
Welcome to my corner of GitHub. This is where experiments, side projects, and curiosity live.  
...
I come from a **software development background** (C, C++, Python, Java) and still like to keep my hands dirty with tech—whether it’s building a home lab, playing with IoT sensors on a Raspberry Pi, or deploying AI apps in the cloud.  

---

## ✨ What you’ll find here  
This repo collection is a mix of:  
- 🚀 **Side projects** – AWS experiments, IoT tinkering, and a sprinkle of Generative AI.  
- 🎮 **Gaming-inspired builds** – from my days competing in WoW & WildStar (yes, those top 3 EU rankings still mean a lot).  
- 📡 **Learning playgrounds** – ChirpStack setups, home lab automation, and “what if I…” ideas.  
- 📖 **Documentation experiments** – I like turning what I learn into reusable notes, templates, and guides.  

Some projects are polished. Others are rough sketches of ideas I’ll revisit later. That’s the point—GitHub is my sandbox.  

---

## 💡 Outside the terminal  
When I’m not buried in code or project boards:  
- 🕹️ I still like to **hack and slash** from time to time.  
- ❤️ I spend as much time as possible with my **lovely wife and our dog**
- 🍲 I hunt for local food experiences wherever I go.  
- 📓 I journal and reflect—because ideas make more sense once written. 

---

## 📬 Connect with me  
- 🌐 [www.sarker.se](https://www.sarker.se)  
- 💼 [LinkedIn](https://www.linkedin.com/in/saqibsarker/)  
- 📨 saqib.sarker@knowit.se  
---
# 💻 Tech Stack:
